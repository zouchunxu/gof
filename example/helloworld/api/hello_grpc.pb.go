...
func (c *greetClient) SayHello(ctx context.Context, in *SayHelloReq, opts ...grpc.CallOption) (*SayHelloRsp, error) {
	out := new(SayHelloRsp)
	err := c.cc.Invoke(ctx, "/api.Greet/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreetServer) SayHello(context.Context, *SayHelloReq) (*SayHelloRsp, error) {
